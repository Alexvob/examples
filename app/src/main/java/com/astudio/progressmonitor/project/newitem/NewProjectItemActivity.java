...
public class NewProjectItemActivity extends NavigationActivity implements ProjectContracts.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Добавить пункт проекта"); //TODO: add string resource
...
//        users.add(0, userHimSelf); //TODO: проверять смепщение в списке и нужно ли очищать users - когда изменятся данные LiveData!
//    }
